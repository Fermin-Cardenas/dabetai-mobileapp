...
const MedicationScreen = () => {
  ...
  const handleContinue = () => {
    console.log('Medicación oral:', selectedType);
    router.push({
      pathname: '/Onboarding/Onboarding10',
      params: { takesMedication: selectedType }
    });
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.title}>¿Actualmente tomas medicación oral (pastillas) para la diabetes?</Text>
      </View>

      {/* Options */}
      <View style={styles.optionsContainer}>
        {medicationOptions.map((type) => (
          <TouchableOpacity
            key={type.id}
            style={[
              styles.optionRow,
