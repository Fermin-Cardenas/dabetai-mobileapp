...
export default function DoctorLinkScreen() {
  const router = useRouter();

  const handleLinkDoctor = () => {
    console.log('Vincular médico');
    router.push('/Onboarding/Onboarding16');
  };
          ...
          <Card style={styles.card}>
            <Card.Content style={{ padding: 0, marginBottom: 0 }}>
              <View style={{ paddingHorizontal: 0 }}>
                <Text style={styles.labelTitle}>Vincula a tu médico</Text>
                <Text style={styles.subtitle}>
                  Conecta tu información con tu profesional de salud de confianza para recibir una atención especializada.
                </Text>
              </View>
            </Card.Content>
