...
const HypertensionScreen = () => {
  ...
  const handleContinue = () => {
    console.log('Hipertensión:', selectedType);
    router.push({
      pathname: '/Onboarding/Onboarding11',
      params: { hasHypertension: selectedType }
    });
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.title}>¿Padeces de hipertensión (presión alta)?</Text>
      </View>

      {/* Options */}
      <View style={styles.optionsContainer}>
        {hypertensionOptions.map((type) => (
          <TouchableOpacity
            key={type.id}
            style={[
              styles.optionRow,
