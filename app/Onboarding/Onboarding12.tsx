...
const SmokingScreen = () => {
  ...
  const handleContinue = () => {
    console.log('Fuma actualmente:', selectedType);
    router.push({
      pathname: '/Onboarding/Onboarding13',
      params: { smokes: selectedType }
    });
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.title}>¿Fumas actualmente?</Text>
      </View>

      {/* Options */}
      <View style={styles.optionsContainer}>
        {smokingOptions.map((type) => (
          <TouchableOpacity
            key={type.id}
            style={[
              styles.optionRow,
