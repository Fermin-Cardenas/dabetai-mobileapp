...
const DiabetesTypeScreen = () => {
  const [selectedType, setSelectedType] = useState('Tipo 1');
  ...
  const handleContinue = () => {
    ...
    router.push({
      pathname: '/Onboarding/Onboarding3', // Cambia por la ruta que necesites
      params: { diabetesType: selectedType }
    });
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.title}>¿Qué tipo de diabetes tienes?</Text>
      </View>
